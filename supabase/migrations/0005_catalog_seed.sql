...
values
  ...
  ('grandfather-clock','Grandfather clock', 'Keeps better time than you do.',              'furniture', 2400, '{"kind":"streak","days":30}',             1, 1, 2, 'tallbox/walnut',    110),
  ('piano',            'Upright piano',     'Slightly out of tune. Endearing.',            'furniture', 4500, '{"kind":"lifetime_hours","hours":100}',   2, 1, 2, 'piano/char',        120),

  -- ---------------------------------------------------------------- plants
  ('succulent',        'Succulent',         'Survives anything, including you.',           'plant',     70,   null,                                      1, 1, 2, 'plant-small/sage',  10),
  ('fern',             'Fern',              'Dramatic about water.',                       'plant',     160,  null,                                      1, 1, 2, 'plant-small/teal',  20),
  ('monstera',         'Monstera',          'Holes on purpose.',                           'plant',     340,  null,                                      1, 1, 2, 'plant-tall/sage',   30),
  ('olive-tree',       'Olive tree',        'Will not fruit indoors. Try anyway.',         'plant',     720,  null,                                      1, 1, 2, 'plant-tall/oak',    40),
  ('bonsai',           'Bonsai',            'Years of patience in a small pot.',           'plant',     1500, '{"kind":"lifetime_hours","hours":50}',    1, 1, 2, 'plant-small/walnut',50),
