...
describe('TimeZoneSelect', () => {
  ...
  it('keeps a stored zone the runtime does not list, rather than dropping it', () => {
    ...
    render(<TimeZoneSelect value="Asia/Calcutta" onChange={vi.fn()} />)
  ...
  it('associates the hint with the control for screen readers', () => {
    render(<TimeZoneSelect value="UTC" onChange={vi.fn()} hint="Decides when your day rolls over." />)
  ...
  it('accepts a custom label', () => {
    render(<TimeZoneSelect value="UTC" onChange={vi.fn()} label="Timezone" />)
